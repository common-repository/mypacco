...
+function (jQuery) { "use strict";
  ...
  Modal.prototype.show = function (_relatedTarget) {
    ...
    this.$element.on('click.dismiss.modal', '[data-dismiss="modal"]', jQuery.proxy(this.hide, this))
  ...
  Modal.prototype.escape = function () {
    if (this.isShown && this.options.keyboard) {
      this.$element.on('keyup.dismiss.bs.modal', jQuery.proxy(function (e) {
  ...
  Modal.prototype.backdrop = function (callback) {
    ...
    if (this.isShown && this.options.backdrop) {
      ...
      this.$element.on('click.dismiss.modal', jQuery.proxy(function (e) {
  ...
  jQuery(document).on('click.bs.modal.data-api', '[data-toggle="modal"]', function (e) {
    ...
    var option  = $target.data('modal') ? 'toggle' : jQuery.extend({ remote: !/#/.test(href) && href }, $target.data(), $this.data())
